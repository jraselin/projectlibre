...
public class FormFormat implements Serializable{
	...
	public static void addDigesterEvents(Digester digester){
	    //layout
		digester.addObjectCreate("*/bar/format/form/layout", "com.projectlibre1.graphic.configuration.FormBoxLayout");
	    digester.addSetProperties("*/bar/format/form/layout");
	    digester.addSetNext("*/bar/format/form/layout", "addLayout", "com.projectlibre1.graphic.configuration.FormBoxLayout");
	    //box
		digester.addObjectCreate("*/bar/format/form/box", "com.projectlibre1.graphic.configuration.FormBox");
	    digester.addSetProperties("*/bar/format/form/box");
	    digester.addSetNext("*/bar/format/form/box", "addBox", "com.projectlibre1.graphic.configuration.FormBox");
	}
